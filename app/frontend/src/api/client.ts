...
export const api = {
  ...
  externalSources: () =>
    request<ExternalSourcesPayload>("/api/external-sources"),
  ...
  checkUpdates: (source: string) =>
    request<ExternalSourceDetailPayload>(
      "/api/external-sources/check-updates",
      {
        method: "POST",
  ...
  updateAll: (source?: string) =>
    request<ExternalSourcesPayload | ExternalSourceDetailPayload>(
      "/api/external-sources/update-all",
      {
        method: "POST",
